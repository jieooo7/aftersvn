...
public class FragmentCouponAdapter extends BaseAdapter {
	...
	if (convertView == null) {
	    ...
	    viewHolder.mImageView = (ImageView) convertView.findViewById(R.id.icon_iv);
	...
	DebugUtil.i("test....result", "44444----" + list.get(position).get("name_url"));

	mImageLoader.DisplayImage(MapPackage.PATH + list.get(position).get("name_url"),
