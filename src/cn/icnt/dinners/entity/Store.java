...
public class Store implements Serializable {
	...
	public Integer getContact_tel() {
		return contact_tel;
	}
	public void setContact_tel(Integer contact_tel) {
		this.contact_tel = contact_tel;
	}
	
	public Store(String address_str, Integer comment_num, Integer company_id,
			...
			String start_time, String store_str, String lager_picture,
			Integer sub_company_id, Integer goods_id, Integer contact_tel) {
		super();
		this.address_str = address_str;
		this.comment_num = comment_num;
		this.company_id = company_id;
	...
	public String toString() {
		return "Store [address_str=" + address_str + ", comment_num="
				...
				+ ", lager_picture=" + lager_picture + ", sub_company_id="
				+ sub_company_id + ", goods_id=" + goods_id + ", contact_tel="
				+ contact_tel + "]";
	}
